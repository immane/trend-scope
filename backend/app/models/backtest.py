...
class BacktestResult(Base):
    ...
    total_return: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    cagr: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    max_drawdown: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    sharpe_ratio: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    sortino_ratio: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    calmar_ratio: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    win_rate: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    profit_factor: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
    num_trades: Mapped[int | None] = mapped_column(Integer, nullable=True)
    benchmark_return: Mapped[float | None] = mapped_column(DECIMAL(18, 6), nullable=True)
